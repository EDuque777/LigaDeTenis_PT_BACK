    ...
    try {
        ...
        await transporter.sendMail({
            ...
            html:  `<h1>Hello ${namefull}</h1>
                    ...
                    <p>Here, you can immerse yourself in a world of tennis, sign up for exciting tournaments and enjoy watching the most exciting games.</p>
        ...
        res.status(200).json({ message: "User Created Successfully", userId: createUser.id, token });
